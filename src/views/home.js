...
<body class="min-h-screen bg-gray-100">
    <header class="bg-white border-b">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <a href="/scan" class="bg-black hover:bg-gray-600 text-white font-bold py-2 px-4 rounded inline-flex items-center">
		...
		(token) => `
			...
			<div class="bg-white rounded-lg shadow-md p-4">
                <div class="flex justify-between items-center mb-2">
                    <h3 class="font-medium text-gray-800">${token.issuer}</h3>
                ...
                <div class="text-2xl font-bold text-gray-900 mb-1">${token.otp}</div>
                <p class="text-sm text-gray-500">Expires in ${token.timeStep} seconds</p>
            </div>
		`,
	)}
                        </div>
